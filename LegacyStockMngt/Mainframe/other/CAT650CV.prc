//CAT650CV PROC HNB=,                     *O/P .CAT650.FILES      GDG *         
...
//             DISP=SHR                                                         
//OUTP2    DD  &P2FL.DSN=&HNB..CAT650.P2&IPT..&TMP2&GENP2,     O/P              
//             DISP=(NEW,CATLG,DELETE),                                         
//             UNIT=&UNIT,                                                      
//             SPACE=&SPACE2,                                                   
//             DCB=(&GDG.DSORG=PS,RECFM=FB,LRECL=120)                           
...
//*                                                                             
//INP2     DD  &P2FL.DSN=&HNB..CAT650.P2&IPT..&TMP2&GENP2,     I/P              
//             DISP=SHR                                                         
...
//             SPACE=&SPACE2,                                                   
//             DCB=(&GDG.DSORG=PS,RECFM=FB,LRECL=120)                           
//OUTP2CV  DD  &P2FL.DSN=&HNB..CAT650.CV&IPT&GENP1,            O/P              
//             DISP=(NEW,CATLG,DELETE),                                         
//             UNIT=&UNIT,                                                      
//             SPACE=&SPACE2,                                                   
//             DCB=(&GDG.DSORG=PS,RECFM=FB,LRECL=120)                           
...
//             DISP=(MOD,DELETE)                                                
//SYSUT003 DD  &P2FL.DSN=&HNB..CAT650.P2&IPT..&TMP2&GENP2,                      
//             DISP=(MOD,DELETE)                                                
//*                                                                             

...
//             DISP=SHR                                                         
//P2FILE   DD  DSN=&HNB..CAT675.AIPP2.TMP&GENP,                 O/P             
//             DISP=(,CATLG,DELETE),                                            
//             UNIT=&UNIT,                                                      
//             SPACE=&SPACE,                                                    
//             DCB=(&GDG.BUFNO=5)                                               
...
//*                                                                             
//CATP2CV8  EXEC PGM=CATP2CV8                                                   
//*                                                                             
//INP2     DD  DSN=&HNB..CAT675.AIPP2.TMP&GENP,                I/P              
//             DISP=SHR                                                         
//AUXFILE  DD DSN=BB.ZZZ.CL010.ACAT.AUXFILE,DISP=SHR                            
//OUTP2    DD  DSN=&HNB..CAT675.AIPP2&GENP,                    O/P              
//             DISP=(NEW,CATLG,DELETE),                                         
//             UNIT=&UNIT,                                                      
//             SPACE=&SPACE,                                                    
//             DCB=(&GDG.DSORG=PS,RECFM=FB,LRECL=80)                            
//OUTP2CV  DD  DSN=&HNB..CAT675.CVPP2&GENP,                    O/P              
//             DISP=(NEW,CATLG,DELETE),                                         
//             UNIT=&UNIT,                                                      
//             SPACE=&SPACE,                                                    
//             DCB=(&GDG.DSORG=PS,RECFM=FB,LRECL=80)                            
...
//SYSUT001 DD DSN=&HNB..CAT675.AIPP2.TMP&GENP,                                  
//             DISP=(MOD,DELETE)                                                

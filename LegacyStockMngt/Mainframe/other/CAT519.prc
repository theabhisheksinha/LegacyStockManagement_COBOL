//CAT519  PROC BYP1=0,                    * 1=BYPASS DATE CHECK       *         
...
//             GDGA='GDG,',               *O/P .CAT519.ACATDLVF       *         
//             GEN='(0)',                 *I/P .CATMMF.LIQUID         *         
//             GEN00A='(+1)',             *I/P .CAT511.ACATTRNS       *         
//             GENP1A='(+1)',             *O/P .CAT519.ACATDLVF       *         
...
//             HNBA='BAAA',               *O/P .CAT519.ACATDLVF   GDG *         
...
//             REGSIZE=8M,                                                      
//             RUNDATE='RERUN.EARLY.',                                          
//             SPACE1='(CYL,(5,2),RLSE)',   *O/P .CAT519.ACATDLVF GDG *         
//             UNIT=BATCH                   *O/P .CAT519.ACATDLVF GDG *         
//*                                                                             
//*********************************************************************         
//*                                                                   *         
//* LOAD ASSETS FOR FULL DELIVERY TRANSFER REQUESTS                   *         
//* OUTPUT = DB2 ACATS TABLES                                         *         
//*                                                                   *         
//*********************************************************************         
//*                                                                             
//CAT519  EXEC PGM=CAT519,                                                      
...
//             DISP=SHR,                                                        
//             AMP='BUFNI=50,BUFND=90'                                          
//INFILE   DD  DSN=&HNB7..CAT511.&WM.ACATTRNS&GEN00A,               I/P         
//             DISP=SHR                                                         
...
//             AMP='BUFNI=50,BUFND=90'                                          
//ACATDLVF DD  DSN=&HNBA..CAT519.ACATDLVF&GENP1A,                   O/P         
//             DISP=(NEW,CATLG,DELETE),                                         
//             SPACE=&SPACE1,                                                   
//             UNIT=&UNIT,                                                      
//             DCB=(&GDGA.DSORG=PS,LRECL=200,RECFM=FB,BLKSIZE=27800)            
//CATWHLD  DD  DSN=&HNBA..CAT519.WHLD&GENP1A,              ASCENDIS O/P         
//             DISP=(NEW,CATLG,DELETE),                                         
//             SPACE=&SPACE1,                                                   
//             UNIT=&UNIT,                                                      
//             DCB=(&GDGA.DSORG=PS,LRECL=62,RECFM=FB)                           
//CATEXCP  DD  DSN=&HNBA..CAT519.EXCP&GENP1A,                                   
//             DISP=(NEW,CATLG,DELETE),                                         
//             SPACE=&SPACE1,                                                   
//             UNIT=&UNIT,                                                      
